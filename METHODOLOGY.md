...
外国私人发行人(只报 20-F、使用 `ifrs-full` 税目者,如台积电)**结构上不在本指数范围内**。
...
`data/book2_conviction.csv` 与 `data/book2_thesis.md` 记录的是**人工裁量持仓**,
**与本指数完全隔离,不影响本指数的任何计算**。分离的目的是让本指数保持
100% 机械、可复现、可审计。
